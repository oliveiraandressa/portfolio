        ...
        <div data-aos="fade-right" data-aos-duration="900">
          ...
          <div class="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs text-gray-400">
            <div class="flex flex-col">
              <span class="text-gray-300 font-semibold">${this.currentLang === 'pt' ? 'Local' : 'Location'}</span>
              <span>${personal.localizacao}</span>
            </div>
            <div class="flex flex-col">
              <span class="text-gray-300 font-semibold">${this.currentLang === 'pt' ? 'Disponível' : 'Available'}</span>
